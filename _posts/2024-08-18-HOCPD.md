...
{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image086.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="U-STFM 模型处理流程图" %}
...
{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image088.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="MODIS叶绿素产品空间降尺度流程图" %}
...
{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image130.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="研究区域1：渤海湾海域，研究区域2：深圳香港海域" %}
...
{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image132.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年3月10日，使用U-STFM图像融合模型（分割区域> 10000）在研究区域的蓝色波段进行24种不同的Rrs预测" %}
...
{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image136.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年3月10日，蓝色波段的U-STFM预测与原始MODIS Rrs 469和Landsat 8 Rrs 482nm的对比" %}

{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image138.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年3月10日，局部海湾区域在蓝色波段的U-STFM预测与原始MODIS Rrs 469和Landsat 8 Rrs 482nm相比" %}
...
{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image140.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年3月10日，绿色波段的U-STFM预测与原始MODIS Rrs 555nm和Landsat 8 Rrs 561 nm相比" %}

{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image142.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="在绿色带中的U-STFM预测中的湾区的子区域" %}
...
{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image144.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="蓝色波段24个U-STFM_M预测的中值位置" %}

{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image148.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年3月10日蓝色和绿色波段的U-STFM模型的1：1预测图" %}
...
{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image150.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年3月10日，蓝色光谱段中STARFM，ESTARFM，U-STFM_M（分割区域数> 10000）和U-STFM_L（分割区域数<1000）的比较" %}

{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image152.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年3月10日，绿色光谱段中STARFM，ESTARFM，U-STFM_M（分割区域数> 10000）和U-STFM_L（分割区域数<1000）的比较" %}
...
{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image154.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年3月10日，蓝色波段中，STARFM的中值，U-STFM_L（分割区域的数量<1000）中值和ESTARFM模型之间的比较" %}

{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image156.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年3月10日，绿色波段中，STARFM的中值，U-STFM_L（分割区域的数量<1000）中值和ESTARFM模型之间的比较" %}
...
{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image166.gif" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年3月10日1km空间分辨率的log10(Blue/Green)和log10（MODIS CHL）之间的相关性" %}
...
{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image168.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年3月10日最终预测30m规模的叶绿素a浓度" %}
...
{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image172.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年3月10日当地标准偏差与9X9窗口的直方图" %}
...
{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image174.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年11月14日，在研究区域2中，与原始MODIS Rrs和Landsat 8 Rrs相比，蓝色和绿色带中的U-STFM的Rrs预测" %}

与图22中蓝色和绿色波段的Landsat 8 Rrs数据相比，U-STFM模型的Rrs预测结果如图22所示。观察和预测之间显示出强烈的线性相关性，R平方为0.8521和0.8857。

{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image176.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年11月14日，研究区域2中蓝色和绿色波段的U-STFM模型预测的1：1图" %}

{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image178.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年11月14日，研究区域2中1km空间分辨率的log10（蓝/绿）和log10（MODIS CHL）之间的相关性" %}
...
{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image180.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="U-STFM的最终叶绿素a浓度预测与Landsat 8和初始MODIS叶绿素a产品相比" %}

{% include figure.liquid path="/SIAT-GeoScience/assets/images/clip_image184.jpg" width="600px" class="z-depth-1 mx-auto d-block" caption="用Landsat 8和MODIS叶绿素a产品进行U-STFM预测的1：1图" %}
