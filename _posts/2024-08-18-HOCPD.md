...
{% include figure.liquid path="/assets/img/posts/2024-08-18-HOCPD/Figure 10.tif" width="600px" class="z-depth-1 mx-auto d-block" caption="蓝色波段24个U-STFM_M预测的中值位置" %}
...
{% include figure.liquid path="/assets/img/posts/2024-08-18-HOCPD/Figure 19.tif" width="600px" class="z-depth-1 mx-auto d-block" caption="2016年3月10日最终预测30m规模的叶绿素a浓度" %}
